	...
	<div id="main" class="container-fluid">
		<div class="row">
			...
			<div id="main" class="col-xs-12 col-sm-10">
				...
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header" style="color: white; text-align: center">Registro de Campañas </h1>
					</div>
					<!-- /.col-lg-12 -->
				</div>
				...
				<div class="box-content">
					...
					<form class="form-horizontal" role="form" action="./#" method="post">
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" class="form-control" placeholder="Nombre Campaña"
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<textarea  class="form-control" placeholder="Descripción de la campaña" rows= "4" cols= "5" data-toggle="tooltip" data-placement="bottom" required></textarea>
							</div>
