	...
	<div id="main" class="container-fluid">
		<div class="row">
			...
			<div id="main" class="col-xs-12 col-sm-10">
				...
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header" style="color: white; text-align: center"> Medico Colaborador</h1>
					</div>
					<!-- /.col-lg-12 -->
				</div>
				...
				<div class="box-content">
					...
					<form class="form-horizontal" role="form" action="./SlMedico" method="post">
						<div class="form-group">
							...
							<label class="col-sm-2 control-label">Colaboracion</label>
							<div class="col-sm-3">
								<input type="text" class="form-control" placeholder="Colaboracion"
									data-toggle="tooltip" data-placement="bottom" required>
							</div>
						...
						<div class="form-group">
							...
							<label class="col-sm-2 control-label">Direccion de trabajo</label>
							<div class="col-sm-3">
								<input type="text" class="form-control" placeholder="Direccion de trabajo"
									data-toggle="tooltip" data-placement="bottom" required>
							</div>
						</div>
						...
						<div class="form-group">
							<label class="col-sm-2 control-label">Código Minsa</label>
							<div class="col-sm-3">
								<input type="text" class="form-control" placeholder="Código Minsa"
									data-toggle="tooltip" data-placement="bottom" required>
							</div>
						</div>
						...
						<div class="col-xs-12">
							<div class="box">
								<div class="box-header">
									<div class="box-name">
										<strong>Medico Colaborador</strong>
									</div>
									<div class="box-icons">
