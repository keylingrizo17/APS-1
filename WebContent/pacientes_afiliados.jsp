<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="datos.paciente, datos.Dt_paciente, java.util.*, java.sql.*"%>
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="utf-8">
	...
	<div id="main" class="container-fluid">
		<div class="row">
			...
			<div id="main" class="col-xs-12 col-sm-10">
				...
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header" style="color: white; text-align: center">Pacientes afiliados</h1>
					</div>
					<!-- /.col-lg-12 -->
				</div>
						...
						<div class="col-xs-12">
							<div class="box">
								<div class="box-header">
									<div class="box-name">
										<strong>Pacientes afiliados</strong>
									</div>
									<div class="box-icons">
