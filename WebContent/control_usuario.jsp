	...
	<div id="main" class="container-fluid">
		<div class="row">
			...
			<div id="main" class="col-xs-12 col-sm-10">
				...
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header" style="color: white; text-align: center"> Control de  usuarios</h1>
					</div>
					<!-- /.col-lg-12 -->
				</div>
				...
				<div class="box-content">
					...
					<form class="form-horizontal" role="form" action="./Registrar_user" method="post">
						<div class="form-group">
							<label class="col-sm-2 control-label">Usuario</label>
							<div class="col-sm-2">
								<input type="text" class="form-control" placeholder="Usuario"
									data-toggle="tooltip" data-placement="bottom" required id="usuario" name="usuario">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="password" class="form-control" placeholder="Contraseña"
									data-toggle="tooltip" data-placement="bottom" required id="contrasenia" name="contrasenia">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<a class="ajax-link action" href="#" id="guardar" onclick="guardar();"><button class="btn btn-danger btn-label btn-block ">Guardar</button></a>
								<!--><button type="submit" class="btn btn-danger btn-label btn-block ">Guardar</button><!-->
							</div>
							
							<div class=" col-sm-2">
								<button type="submit" class="btn btn-danger btn-label btn-block ">Modificar</button>
							</div>
							
							<div class="col-sm-2">
								<button type="submit" class="btn btn-danger btn-label btn-block ">Eliminar</button>
							</div>
				...
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header" style="color: white; text-align: left"> Asinarle un rol al usuario</h1>
					</div>
					<!-- /.col-lg-12 -->
				</div>
				...
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header" style="color: white; text-align: left"> Asinarle permisos al rol</h1>
					</div>
					<!-- /.col-lg-12 -->
				</div>
					...
					<div class="row">
						<div class="col-xs-12">
							<div class="box">
								<div class="box-header">
									<div class="box-name">
										<strong>Permisos de los roles</strong>
									</div>
									<div class="box-icons">
										<a class="collapse-link"> <i class="fa fa-chevron-up"></i>
										</a> <a class="expand-link"> <i class="fa fa-expand"></i>
...
function guardar()
{
	...
	({
		...
		type: "post",
		datatype: 'html',
		data: {'fusuario' :fname, 'susuario':sname},
