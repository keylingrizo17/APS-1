		...
		<div class="row">
			...
			<div id="main" class="col-xs-12 col-sm-10">
				...
				<div class="box-content">
					...
					<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header" style="color: white; text-align: center">Historia clínica</h1>
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<select id="s3_with_tag" multiple="multiple"
									class="populate placeholder" required>
									<option>Pleuresía</option>
									<option>Pericardítis</option>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<select id="s5_with_tag" multiple="multiple"
									...
									<option>Desorientación</option>
									<option>Depresión</option>
									<option>Convulsión</option>
				...
				<div class="box-content">
					...
					<form class="form-horizontal" role="form">
						...
						<div class="form-group">
							<label class="col-sm-2 control-label">Daño renal</label>
							<div class="col-sm-2">
